<template>
	<view class="category-mini-card">
		...
		<view class="content">
			...
			<text v-if="category.spec.childrenCategories && category.spec.childrenCategories.length == 0" class="label">共 {{ category.postCount }} 篇</text>
			<text v-else class="label">共 {{ category.spec.childrenCategories.length }} 个分类</text>
		</view>
	</view>
</template>
