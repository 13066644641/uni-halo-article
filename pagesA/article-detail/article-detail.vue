<template>
    <view class="app-page" ref="appRef" :style="{ backgroundImage: `url(${backgroundImageUrl})` }">
        ...
        <block v-else>
            ...
            <view class="head ma-24">
                ...
                <view class="detail">
                    ...
                    <view class="count hidden" :class="{ 'no-thumbnail': !result.spec.cover }">
                    ...
                    <view
                        ...
                        <view v-if="postDetailConfig.copyrightViolation"
                            ...
                            侵权处理：{{ postDetailConfig.copyrightViolation }}
								...
								<button class="contact-author" type="primary" open-type="contact">联系作者</button>
                <!-- 评论展示区域 -->
            ...
            <tm-flotbutton  class="hidden":actions="flotButtonActions" :click-actions-hiden="false" actions-pos="left"
...
export default {
    ...
    data() {
        return {
            ...
            commentListScrollTop: 0,
						backgroundImageUrl: HaloTokenConfig.BASE_API + '/upload/article-background.webp'
        };
    },
    computed: {
        haloConfigs() {
    ...
    onLoad(e) {
		...
		mounted(){
				console.log(`url('${HaloTokenConfig.BASE_API}/upload/article-background.webp')`)
				this.$refs.appRef.$el.style.backgroundImage = `url('${HaloTokenConfig.BASE_API}/upload/article-background.webp')`;
		},
    onPullDownRefresh() {
        this.fnGetData();
    },
